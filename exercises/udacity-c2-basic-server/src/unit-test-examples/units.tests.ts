...
describe('concat', () => {
  ...
  it('should combine "a" and "b"', () => {
    const result = concat("a","b")
    expect(result).to.equal("ab");
  });

  it('should throw an error if "" and "b"', () => {
    expect(()=>{ concat("","b") }).to.throw('string can not be empty!')
  });

  it('should throw an error if "a" and ""', () => {
    expect(()=>{ concat("a","") }).to.throw('string can not be empty!')
  });

  it('should throw an error if "" and ""', () => {
    expect(()=>{ concat("","") }).to.throw('string can not be empty!')
  });
